...
import { EmpleadosLogComponent } from './component/usuarios/empleados/empleados-log/empleados-log.component';
import { EmpleadoresLogComponent } from './component/usuarios/empleadores/empleadores-log/empleadores-log.component';
import { DialogoComponent } from './component/landing/header/dialogo/dialogo.component';
...
@NgModule({
  declarations: [
    ...
    EmpleadosLogComponent,
    EmpleadoresLogComponent,
    DialogoComponent,
  ],
  imports: [
    Ng2SearchPipeModule,
